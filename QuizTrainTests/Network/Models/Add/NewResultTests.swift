...
class NewResultTests: XCTestCase, AddModelTests, ValidatableTests {

    typealias Object = NewResult
...
extension NewResultTests {
    ...
    struct Properties {
        ...
        struct Optional {
            ...
            static let statusId = 10
            static let version = "1.2.3"
            static let customFields = NewResultTests.customFields
        }
...
extension NewResultTests: CustomFieldsDataProvider { }

// MARK: - Objects

extension NewResultTests: ObjectProvider {
...
extension NewResultTests: ValidatableObjectProvider {
...
extension NewResultTests: AssertAddRequestJSON { }

extension NewResultTests: AssertCustomFields { }

extension NewResultTests: AssertEquatable { }

extension NewResultTests: AssertJSONSerializing { }

extension NewResultTests: AssertProperties {
    ...
    func assertVariablePropertiesCanBeChanged(in object: inout Object) {
        ...
        object.customFields = NewResultTests.emptyCustomFields
        ...
        XCTAssertEqual(object.customFields.count, NewResultTests.emptyCustomFields.count)
...
extension NewResultTests: AssertValidatable { }
