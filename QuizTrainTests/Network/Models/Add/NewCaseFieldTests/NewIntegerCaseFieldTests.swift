...
class NewIntegerCaseFieldTests: XCTestCase, AddModelTests, CodableTests {

    typealias Object = NewCaseField<NewCaseFieldIntegerData>
...
extension NewIntegerCaseFieldTests {
...
extension NewIntegerCaseFieldTests: ObjectProvider {
...
extension NewIntegerCaseFieldTests: AssertAddRequestJSON { }

extension NewIntegerCaseFieldTests: AssertCodable { }

extension NewIntegerCaseFieldTests: AssertEquatable { }

extension NewIntegerCaseFieldTests: AssertJSONSerializing { }

extension NewIntegerCaseFieldTests: AssertProperties {
    ...
    func assertRequiredProperties(in object: Object) {
        ...
        XCTAssertEqual(object.type, NewCaseFieldType.integer)
    ...
    func assertVariablePropertiesCanBeChanged(in object: inout Object) {
        ...
        config.options.defaultValue = 999

        // Update Context/Options through .data.
        object.data = NewCaseFieldIntegerData(configs: [config])
        ...
        XCTAssertEqual(object.configs[0].options.defaultValue, 999)
