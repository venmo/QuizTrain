...
class NewMilestoneCaseFieldTests: XCTestCase, AddModelTests, CodableTests {

    typealias Object = NewCaseField<NewCaseFieldMilestoneData>
...
extension NewMilestoneCaseFieldTests {
...
extension NewMilestoneCaseFieldTests: ObjectProvider {
...
extension NewMilestoneCaseFieldTests: AssertAddRequestJSON { }

extension NewMilestoneCaseFieldTests: AssertCodable { }

extension NewMilestoneCaseFieldTests: AssertEquatable { }

extension NewMilestoneCaseFieldTests: AssertJSONSerializing { }

extension NewMilestoneCaseFieldTests: AssertProperties {
    ...
    func assertRequiredProperties(in object: Object) {
        ...
        XCTAssertEqual(object.type, NewCaseFieldType.milestone)
    ...
    func assertVariablePropertiesCanBeChanged(in object: inout Object) {
        ...
        object.data = NewCaseFieldMilestoneData(configs: [config])
