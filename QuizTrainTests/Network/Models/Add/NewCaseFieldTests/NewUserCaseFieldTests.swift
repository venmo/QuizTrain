...
class NewUserCaseFieldTests: XCTestCase, AddModelTests, CodableTests {

    typealias Object = NewCaseField<NewCaseFieldUserData>
...
extension NewUserCaseFieldTests {
...
extension NewUserCaseFieldTests: ObjectProvider {
...
extension NewUserCaseFieldTests: AssertAddRequestJSON { }

extension NewUserCaseFieldTests: AssertCodable { }

extension NewUserCaseFieldTests: AssertEquatable { }

extension NewUserCaseFieldTests: AssertJSONSerializing { }

extension NewUserCaseFieldTests: AssertProperties {
    ...
    func assertRequiredProperties(in object: Object) {
        ...
        XCTAssertEqual(object.type, NewCaseFieldType.user)
    ...
    func assertVariablePropertiesCanBeChanged(in object: inout Object) {
        ...
        object.data = NewCaseFieldUserData(configs: [config])
