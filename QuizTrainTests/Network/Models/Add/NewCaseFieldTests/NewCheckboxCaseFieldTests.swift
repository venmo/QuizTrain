...
class NewCheckboxCaseFieldTests: XCTestCase, AddModelTests, CodableTests {

    typealias Object = NewCaseField<NewCaseFieldCheckboxData>
...
extension NewCheckboxCaseFieldTests: ObjectProvider {
...
extension NewCheckboxCaseFieldTests: AssertAddRequestJSON { }

extension NewCheckboxCaseFieldTests: AssertCodable { }

extension NewCheckboxCaseFieldTests: AssertEquatable { }

extension NewCheckboxCaseFieldTests: AssertJSONSerializing { }

extension NewCheckboxCaseFieldTests: AssertProperties {
    ...
    func assertRequiredProperties(in object: Object) {
        ...
        XCTAssertEqual(object.type, NewCaseFieldType.checkbox)
    ...
    func assertVariablePropertiesCanBeChanged(in object: inout Object) {
        ...
        config.options.defaultValue = true

        // Update Context/Options through .data.
        object.data = NewCaseFieldCheckboxData(configs: [config])
        ...
        XCTAssertEqual(object.configs[0].options.defaultValue, true)
