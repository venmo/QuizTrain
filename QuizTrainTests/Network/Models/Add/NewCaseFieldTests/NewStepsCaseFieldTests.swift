...
class NewStepsCaseFieldTests: XCTestCase, AddModelTests, CodableTests {

    typealias Object = NewCaseField<NewCaseFieldStepsData>
...
extension NewStepsCaseFieldTests {
    ...
    struct Properties {
        ...
        struct Required {
            ...
            static let format = NewCaseFieldConfigStepsOptions.Format.plain
            static let hasExpected = false
            static let rows = NewCaseFieldConfigStepsOptions.Rows.five
        }
...
extension NewStepsCaseFieldTests: ObjectProvider {
    ...
    static var objectWithRequiredProperties: Object {
        return Object(description: nil,
                      ...
                      hasExpected: Properties.Required.hasExpected,
...
extension NewStepsCaseFieldTests: AssertAddRequestJSON { }

extension NewStepsCaseFieldTests: AssertCodable { }

extension NewStepsCaseFieldTests: AssertEquatable { }

extension NewStepsCaseFieldTests: AssertJSONSerializing { }

extension NewStepsCaseFieldTests: AssertProperties {
    ...
    func assertRequiredProperties(in object: Object) {
        ...
        XCTAssertEqual(object.type, NewCaseFieldType.steps)
        ...
        XCTAssertEqual(config.options.hasExpected, Properties.Required.hasExpected)
    ...
    func assertVariablePropertiesCanBeChanged(in object: inout Object) {
        ...
        object.data = NewCaseFieldStepsData(configs: [config])
