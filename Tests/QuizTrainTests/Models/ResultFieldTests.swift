...
class ResultFieldTests: XCTestCase, ModelTests {

    typealias Object = ResultField
...
extension ResultFieldTests: JSONDataProvider {
...
extension ResultFieldTests: ObjectProvider {
...
extension ResultFieldTests: AssertEquatable { }

extension ResultFieldTests: AssertJSONDeserializing { }

extension ResultFieldTests: AssertJSONSerializing { }

extension ResultFieldTests: AssertJSONTwoWaySerialization { }

extension ResultFieldTests: AssertProperties {
