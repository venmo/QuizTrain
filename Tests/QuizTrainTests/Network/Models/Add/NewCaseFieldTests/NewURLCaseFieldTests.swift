...
class NewURLCaseFieldTests: XCTestCase, AddModelTests, CodableTests {

    typealias Object = NewCaseField<NewCaseFieldURLData>
...
extension NewURLCaseFieldTests {
    ...
    struct Properties {
        ...
        struct Optional {
            ...
            static let defaultValue = URL(string: "https://github.com/venmo/QuizTrain/")
        }
...
extension NewURLCaseFieldTests: ObjectProvider {
...
extension NewURLCaseFieldTests: AssertAddRequestJSON { }

extension NewURLCaseFieldTests: AssertCodable { }

extension NewURLCaseFieldTests: AssertEquatable { }

extension NewURLCaseFieldTests: AssertJSONSerializing { }

extension NewURLCaseFieldTests: AssertProperties {
    ...
    func assertRequiredProperties(in object: Object) {
        ...
        XCTAssertEqual(object.type, NewCaseFieldType.url)
    ...
    func assertVariablePropertiesCanBeChanged(in object: inout Object) {
        ...
        config.options.defaultValue = URL(string: "https://www.venmo.com/")

        // Update Context/Options through .data.
        object.data = NewCaseFieldURLData(configs: [config])
        ...
        XCTAssertEqual(object.configs[0].options.defaultValue, URL(string: "https://www.venmo.com/"))
